...
def main_2d():  # pragma: no cover
    ...
    # x = [-2.5, 0.0, 2.5, 5.0, 7.5, 3.0, -1.0]
    # y = [0.7, -6, 5, 6.5, 0.0, 5.0, -2.0]
    path = np.loadtxt(r"C:\Users\joaqu\OneDrive\Documents\MATLAB\Bahr_to_business_complex_path_no_commas.txt")
    x=[]
    y=[]
    # Read and process the input file
    # Process the data from the NumPy array
    for row in path:
        x.append(float(row[0]))  # First column as x
        y.append(float(row[1]))  # Second column as y
